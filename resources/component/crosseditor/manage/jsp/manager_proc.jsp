...
<%
	...
	if(check){
		result_sc = "<script type='text/javascript' language='javascript'>alert(NamoSELang.pe_zs);window.document.location.href='manager_setting.jsp?Tab=" + detectXSSEx(request.getParameter("Tab")) + "';</script>";
	}
	else{
		result_sc = "<script>alert(NamoSELang.pe_ul+'" + fileName + "');history.back();</script> ";
	}
