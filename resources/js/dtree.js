...
dTree.prototype.toString = function() {
	...
	var str = '<div class="dtree scroll">\n';
...
dTree.prototype.node = function(node, nodeId) {
	var str = '<div class="dTreeNode"><span class="inline-block">' + this.indent(node, nodeId);
	if (this.config.useIcons) {
		...
		str += '<span class="tree-type"><img id="i' + this.obj + nodeId + '" src="' + ((node._io) ? node.iconOpen : node.icon) + '" alt=""></span></span><span class="display-block">';
	}
	if (node.url) {
...
dTree.prototype.indent = function(node, nodeId) {
	...
	if (this.root.id != node.pid) {
		for (var n=0; n<this.aIndent.length; n++)
			str += '<span class="line"><img src="' + ( (this.aIndent[n] == 1 && this.config.useLines) ? this.icon.line : this.icon.empty ) + '" alt=""></span>';
		...
		if (node._hc) {
			...
			str += '" alt=""></a>';
		} else str += '<span class="last-line"><img src="' + ( (this.config.useLines) ? ((node._ls) ? this.icon.joinBottom : this.icon.join ) : this.icon.empty) + '" alt=""></span>';
	}
	return str;
};
